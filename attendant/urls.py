...
urlpatterns = [
    ...
    path('appointments/<int:appointment_id>/diagnose/', views.attendant_diagnose_appointment, name='diagnose_appointment'),
    path('appointments/<int:appointment_id>/perform-service/', views.attendant_perform_service, name='perform_service'),
    ...
    # leave request feature removed; attendants should contact staff directly
    # API endpoints
